...
<body>
    ...
    <div class="container main-container">
        ...
        <p>Our Privacy Policy can be found at <a href="/privacy/">https://inXys.net/privacy/</a>.</p>
        ...
        <h4>inXys.net Publisher Policies</h4>
        <p>When you contribute your content to this Site you are considered a publisher of content to the Users of this Site and you are required to adhere to the following policies. Failure to comply with these policies may result in the Site blocking you or your contributions from appearing on the Site, or suspending or terminating your account.</p>
        <p>These policies apply in addition to any other policies governing your use of the Site.</p>
        <h5>Illegal content</h5>
        <p>We do not allow content that:
        <ol>
            <li>is illegal, promotes illegal activity, or infringes on the legal rights of others.</li>
            <li>infringes copyright. It is our policy to respond to notices of alleged infringement that comply with the Digital Millennium Copyright Act (DMCA). You can file a counter-notification via <a href="/contact/">contact form</a>.</li>
            <li>sells or promotes the sale of counterfeit products. Counterfeit goods contain a trademark or logo that is identical to or substantially indistinguishable from the trademark of another. They mimic the brand features of the product in an attempt to pass themselves off as a genuine product of the brand owner.</li>
            <li>incites hatred against, promotes discrimination of, or disparages an individual or group on the basis of their race or ethnic origin, religion, disability, age, nationality, veteran status, sexual orientation, gender, gender identity, or other characteristic that is associated with systemic discrimination or marginalization. Examples: Promoting hate groups or hate group paraphernalia, encouraging others to believe that a person or group is inhuman, inferior, or worthy of being hated harasses, intimidates, or bullies an individual or group of individuals.</li>
            <li>singles out someone for purpose of abuse or harassment, suggesting a tragic event did not happen or that victims or their families are actors or complicit in a cover-up of the event, threatens or advocates for physical or mental harm to oneself or others.</li>
            <li>content advocating suicide, anorexia, or other self-harm; threatening someone with real-life harm or calling for the attack of another person; promoting, glorifying, or condoning violence against others; content made by or in support of terrorist groups or transnational drug trafficking organizations, or content that promotes terrorist acts, including recruitment, or that celebrates attacks by transnational drug trafficking or terrorist organizations, exploits others through extortion.</li>
            <li>promotes cruelty or gratuitous violence towards animals.</li>
            <li>promotes the sale of products obtained from endangered or threatened species.</li>
            <li>misrepresents, misstates, or conceals information about you, the publisher, the content creator, the purpose of the content, or the content itself.</li>
            <li>falsely implies having an affiliation with, or endorsement by, another individual, organization, product, or service.</li>
            <li>makes claims that are demonstrably false and could significantly undermine participation or trust in an electoral or democratic process.</li>
            <li>promotes harmful health claims, or relates to a current, major health crisis and contradicts authoritative scientific consensus.</li>
            <li>contradicts authoritative scientific consensus on climate change.</li>
            <li>enticing users to engage with content under false or unclear pretenses.</li>
            <li>attempting to steal personal information or trick users into sharing personal information.</li>
            <li>promoting content, products, or services using false, dishonest, or deceptive claims.</li>
            <li>coordinating with other sites or accounts and concealing or misrepresenting your identity or other material details about yourself, where your content relates to politics, social issues or matters of public concern.</li>
            <li>directing content about politics, social issues, or matters of public concern to users in a country other than your own, if you misrepresent or conceal your country of origin or other material details about yourself.</li>
            <li>deceives users through manipulated media related to politics, social issues, or matters of public concern.</li>
            <li>helps users to mislead others, such as creating fake or false documents such as passports, diplomas, or accreditation; sale or distribution of term papers, paper-writing or exam-taking services; information or products for passing drug tests.</li>
            <li>promotes any form of hacking or cracking and/or provides users with instructions, equipment, or software that tampers with or provides unauthorized access to devices, software, servers, or websites.</li>
            <li>enables a user, or promotes products and services that enable a user, to track or monitor another person or their activities without their authorization.</li>
            <li>includes graphic sexual text, image, audio, video, or games.</li>
            <li>contains non-consensual sexual themes, whether simulated or real.</li>
            <li>promotes the creation or distribution of content that has been altered or generated to be sexually explicit or contain nudity.</li>
            <li>may be interpreted as promoting a sexual act in exchange for compensation.</li>
            <li>facilitates marriage to a foreigner.</li>
            <li>is made to appear appropriate for a family audience, but contains adult themes including sex, violence, or other depictions of children or popular children's characters that are unsuitable for a general audience.
            <li>sexually exploits or abuses children or content that promotes the sexual exploitation or abuse of children. This includes all child sexual abuse materials.</li>
            <li>endangers children. We will take appropriate action, which may include reporting to the National Center for Missing & Exploited Children and disabling accounts. If you believe a child is in danger of or has been subject to abuse, exploitation, or trafficking, contact the police immediately.</li>
        </ol>
        </p>
